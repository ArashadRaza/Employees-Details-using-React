...
function App() {
  ...
  return (
    <div className="container">
      ...
      <h3 className='d-flex'><u>(Based on CRUD Operation)</u></h3>
      ...
      <Modal open={open} onClose={onCloseModal} center>
        ...
        <div className="form">
          ...
          <textarea name="address" id="" cols="30" rows="5" value={user.address} onChange={(e) => setUser({ ...user, "address": e.target.value })}></textarea>
